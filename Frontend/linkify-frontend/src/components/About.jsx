...
const About = () => {
  return (
   <div className="lg:px-14 sm:px-8 px-5 min-h-[calc(100vh-64px)] pt-2">
      <div className="bg-background w-full sm:py-10 py-8  ">
        <h1 className="sm:text-4xl text-card-title text-3xl font-bold italic  mb-3">
          About Linkify
        </h1>
        <p className="text-para-color text-sm  mb-8 xl:w-[60%] lg:w-[70%] sm:w-[80%] w-full ">
        ...
        <div className="space-y-5 xl:w-[60%] lg:w-[70%] sm:w-[80%] w-full ">
          <div className="flex items-start">
            ...
            <div>
              <h2 className="sm:text-2xl font-bold text-card-title">
